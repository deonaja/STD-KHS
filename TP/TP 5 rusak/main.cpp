...
int main()
{
    ...
    while (!status) {
        if (menu == 1) {
            cout << "Jumlah data yang akan ditambahkan (List 1) : ";
            cin >> n;
            while (n > 0) {
            ...
            cout << "Jumlah data yang akan ditambahkan (List 2) : ";
            cin >> n;
            while (n > 0) {
                cout << endl << "Masukkan data baru : ";
                cin >> x;
                p = newElm_103032300101(x);
                insertLast_103032300101(ais, p);
                n--;
            }
        } else if (menu == 2) {
            showAllData_103032300101(l);
            showAllData_103032300101(ais);
            cetakElem(l, ais);
        } else if (menu == 3) {
